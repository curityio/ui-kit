...
const htmlFormLogin: HaapiActionStep = {
  links: [
    { href: '/authentication/authenticate/user-pwd/forgot-password', rel: 'forgot-password', title: 'Forgot your password?' },
    { href: '/authentication/authenticate/user-pwd/forgot-account-id', rel: 'forgot-account-id', title: 'Forgot your username?' },
  ...
  actions: [
    {
      ...
      model: {
        options: [
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'Google', properties: { authenticatorType: 'google' }, model: { href: '/authentication/authenticate/google', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'TOTP', properties: { authenticatorType: 'totp' }, model: { href: '/authentication/authenticate/totp', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'Username/password', properties: { authenticatorType: 'html-form' }, model: { href: '/authentication/authenticate/user-pwd', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'Email', properties: { authenticatorType: 'email' }, model: { href: '/authentication/authenticate/email', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'SMS', properties: { authenticatorType: 'sms' }, model: { href: '/authentication/authenticate/sms', method: HTTP_METHODS.GET } },
        ],
      },
    },
  ],
  ...
  actions: [
    {
      ...
      model: {
        ...
        type: MEDIA_TYPES.FORM_URLENCODED,
        actionTitle: 'Verify',
        fields: [{ name: 'otp', type: HAAPI_FORM_FIELDS.TEXT, label: 'OTP code', kind: 'number', minLength: 8, maxLength: 8 }],
      },
    },
  ],
};
  ...
  actions: [
    {
      ...
      model: {
        ...
        fields: [
          ...
          { type: HAAPI_FORM_FIELDS.USERNAME, name: 'user', label: 'Username', placeholder: 'Enter your username', required: false },
  ...
  actions: [
    {
      ...
      model: {
        ...
        fields: [
          ...
          { type: HAAPI_FORM_FIELDS.CHECKBOX, name: 'always-checked', label: 'No option', value: 'yes', checked: true, readonly: true },
        ],
        actionTitle: 'Submit',
      },
    },
        ...
        arguments: {
          credentialCreationOptions: {
            publicKey: {
              ...
              hints: [],
              excludeCredentials: [],
              authenticatorSelection: { requireResidentKey: false, residentKey: 'preferred', userVerification: 'required' },
              attestation: 'none',
              extensions: {},
            },
          },
  ...
  actions: [
    {
      ...
      model: {
        options: [
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'PingFederate', properties: { authenticatorType: 'pingfederate' }, model: { href: '/authentication/authenticate/pingfederate', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'Username/password', properties: { authenticatorType: 'html-form' }, model: { href: '/authentication/authenticate/user-pwd', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'Email', properties: { authenticatorType: 'email' }, model: { href: '/authentication/authenticate/email', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: 'select-authenticator', title: 'SMS', properties: { authenticatorType: 'sms' }, model: { href: '/authentication/authenticate/sms', method: HTTP_METHODS.GET } },
        ],
  ...
  actions: [
    {
      ...
      model: {
        options: [
          { template: HAAPI_ACTION_TYPES.FORM, kind: HAAPI_FORM_ACTION_KINDS.AUTHENTICATOR_SELECTOR_OPTION, title: 'BankID', properties: { authenticatorType: HAAPI_ACTION_CLIENT_OPERATIONS.BANKID }, model: { href: '/authentication/authenticate/bankid', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: HAAPI_FORM_ACTION_KINDS.AUTHENTICATOR_SELECTOR_OPTION, title: 'Username/password', properties: { authenticatorType: 'html-form' }, model: { href: '/authentication/authenticate/user-pwd', method: HTTP_METHODS.GET } },
          { template: HAAPI_ACTION_TYPES.FORM, kind: HAAPI_FORM_ACTION_KINDS.AUTHENTICATOR_SELECTOR_OPTION, title: 'Email', properties: { authenticatorType: 'email' }, model: { href: '/authentication/authenticate/email', method: HTTP_METHODS.GET } },
        ],
      },
    },
  ],
...
export const EXAMPLES: Record<HAAPI_EXAMPLE, ExampleEntry> = {
  // Browsable showcase — Authenticators
  [HAAPI_EXAMPLE.AUTHENTICATORS_HTML_FORM_LOGIN]: { title: 'Login', section: 'Authenticators', step: authenticatorHtmlFormLogin, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_HTML_FORM_ACCOUNT_CREATED]: { title: 'Account Created (hyperlink)', section: 'Authenticators', step: authenticatorHtmlFormAccountCreatedHyperlink, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_HTML_FORM_ACTIVATE_OTP]: { title: 'Activate (OTP)', section: 'Authenticators', step: authenticatorHtmlFormOtpActivation, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_WEBAUTHN_SELECT_DEVICE]: { title: 'Registration (select device)', section: 'Authenticators', step: authenticatorWebauthnRegistrationAnyDevice, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_WEBAUTHN_PASSKEY]: { title: 'Registration (Passkey)', section: 'Authenticators', step: authenticatorWebauthnRegistrationPasskeys, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_WEBAUTHN_COMPLETED]: { title: 'Registration Completed', section: 'Authenticators', step: authenticatorWebauthnRegistrationCompleted, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_DUO_SELECT_DEVICE]: { title: 'Duo - Select Device', section: 'Authenticators', step: authenticatorDuoSelectDevice, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_EMAIL_LINK_WAIT]: { title: 'Link Wait', section: 'Authenticators', step: authenticatorEmailLinkWait, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATORS_EMAIL_OTP]: { title: 'OTP', section: 'Authenticators', step: authenticatorEmailOtp, kind: 'step' },
  // Browsable showcase — Authentication Actions
  [HAAPI_EXAMPLE.AUTHENTICATION_ACTIONS_REQUEST_ACK]: { title: 'Request Acknowledgement', section: 'Authentication Actions', step: authenticationActionRequestAck, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATION_ACTIONS_RESET_PASSWORD]: { title: 'Reset Password', section: 'Authentication Actions', step: authenticationActionResetPassword, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATION_ACTIONS_OPT_IN_MFA_SETUP]: { title: 'Setup', section: 'Authentication Actions', step: authenticationActionOptInMfaSetup, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATION_ACTIONS_OPT_IN_MFA_SETUP_CONFIRM]: { title: 'Setup confirm', section: 'Authentication Actions', step: authenticationActionOptInMfaSetupConfirm, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATION_ACTIONS_OPT_IN_MFA_SELECT]: { title: 'Select', section: 'Authentication Actions', step: authenticationActionOptInMfaSelect, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATION_ACTIONS_SELECTOR]: { title: 'Selector', section: 'Authentication Actions', step: authenticationActionSelector, kind: 'step' },
  [HAAPI_EXAMPLE.AUTHENTICATION_ACTIONS_SIGN_UP]: { title: 'Sign Up', section: 'Authentication Actions', step: authenticationActionSignUp, kind: 'step' },
  // Browsable showcase — Authentication
  [HAAPI_EXAMPLE.AUTHENTICATION_SELECT_AUTHENTICATOR]: { title: 'Select Authenticator', section: 'Authentication', step: authenticationSelectAuthenticator, kind: 'step' },
  // Browsable showcase — OAuth
  [HAAPI_EXAMPLE.OAUTH_USER_CONSENT]: { title: 'User Consent', section: 'OAuth', step: oauthUserConsent, kind: 'step' },
  // Browsable showcase — Forms
  [HAAPI_EXAMPLE.FORMS_DIFFERENT_INPUTS]: { title: 'Form with Different Inputs', section: 'Forms', step: formStepWithDifferentInputs, kind: 'step' },
  [HAAPI_EXAMPLE.FORMS_AUTHENTICATION_ERROR]: { title: 'Form with Authentication Error', section: 'Forms', step: formStepWithUsernamePassword, errorOnSubmit: authenticationFailedError, autoSubmit: true, kind: 'step' },
  [HAAPI_EXAMPLE.FORMS_VALIDATION_ERROR]: { title: 'Form with Validation Error', section: 'Forms', step: formStepWithUsernamePassword, errorOnSubmit: inputValidationError, autoSubmit: true, kind: 'step' },
  [HAAPI_EXAMPLE.FORMS_HIDDEN_FIELD]: { title: 'Form with Hidden Field', section: 'Forms', step: formStepWithHiddenField, kind: 'step' },
  // Customization-pinned steps
  [HAAPI_EXAMPLE.HTML_FORM_LOGIN]: { title: 'HTML Form Login', section: 'Customizations', step: htmlFormLogin, errorOnSubmit: authenticationFailedError, kind: 'customization' },
  [HAAPI_EXAMPLE.SELECT_AUTHENTICATOR]: { title: 'Select Authenticator', section: 'Customizations', step: selectAuthenticator, kind: 'customization' },
  [HAAPI_EXAMPLE.EMAIL_OTP]: { title: 'Email OTP', section: 'Customizations', step: emailOtp, kind: 'customization' },
  [HAAPI_EXAMPLE.LOGIN_WITH_VALIDATION]: { title: 'Login with Validation', section: 'Customizations', step: usernamePasswordForm, errorOnSubmit: inputValidationError, autoSubmit: true, kind: 'customization' },
  [HAAPI_EXAMPLE.DIFFERENT_INPUTS]: { title: 'Form with Different Inputs', section: 'Customizations', step: formWithDifferentInputs, kind: 'customization' },
  [HAAPI_EXAMPLE.POLLING]: { title: 'Polling', section: 'Customizations', step: emailLinkWaitPolling, kind: 'customization' },
  [HAAPI_EXAMPLE.CLIENT_OPERATION]: { title: 'Client Operation', section: 'Customizations', step: webauthnClientOperation, kind: 'customization' },
  [HAAPI_EXAMPLE.GROUP_AUTHENTICATOR]: { title: 'Group Authenticator', section: 'Customizations', step: groupAuthenticator, kind: 'customization' },
  [HAAPI_EXAMPLE.CUSTOM_AUTHENTICATOR_SELECT]: { title: 'Custom Authenticator Select', section: 'Customizations', step: customAuthenticatorSelect, kind: 'customization' },
  [HAAPI_EXAMPLE.BANKID_WAIT]: { title: 'BankID Wait', section: 'Customizations', step: bankidWaitStep, kind: 'customization' },
  [HAAPI_EXAMPLE.COMPLETED]: { title: 'Completed', section: 'Customizations', step: completedSuccessStep, kind: 'customization' },
};

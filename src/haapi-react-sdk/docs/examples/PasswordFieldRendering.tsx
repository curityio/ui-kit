...
import { HaapiStepperPasswordFormFieldUI } from '@curity/haapi-react-sdk/haapi-stepper/feature/actions/form/fields/HaapiStepperPasswordFormFieldUI';
...
/** Add a "forgot password?" link under the password field with `HaapiStepperPasswordFormFieldUI`; keep the default for the rest. */
function LoginForm() {

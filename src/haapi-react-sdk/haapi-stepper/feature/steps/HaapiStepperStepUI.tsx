...
import { formatStepData } from '../stepper/data-formatters/format-step-data';
 ...
 * };
 * ```
 * {@see_example ./docs/sections/01-api-reference/StepRenderInterceptorHaapiReactSDKPlaygroundExample.tsx}
 *
 ...
 * };
 * ```
 * {@see_example ./docs/sections/01-api-reference/StepBehaviorRenderInterceptorHaapiReactSDKPlaygroundExample.tsx}
 *
...
export const HaapiStepperStepUI = (props: HaapiStepperStepUIProps) => {
  ...
  if (stepRenderInterceptor) {
    ...
    haapiStepperUiAPI = {
      ...
      currentStep: formatStepData(stepRenderInterceptorResult.currentStep),
    };
  }

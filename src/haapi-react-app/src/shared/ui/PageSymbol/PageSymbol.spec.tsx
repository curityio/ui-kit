...
const buildConfig = (pageSymbols?: HaapiStepperPageSymbols): HaapiAppConfig => ({
...
const renderPageSymbol = (viewName: string | undefined, pageSymbols?: HaapiStepperPageSymbols) =>
  render(
...
describe('PageSymbol', () => {
  const pageSymbols: HaapiStepperPageSymbols = {
    views: {

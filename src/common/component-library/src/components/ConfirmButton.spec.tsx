...
describe('ConfirmButton', () => {
  it('opens dialog when clicked', () => {
    render(<ConfirmButton title="Delete" data-testid="confirm-button" t={translationFunctionMock} />);
  ...
  it('handles cancel action correctly', async () => {
    ...
    render(
      <ConfirmButton title="Delete" onCancel={onCancelMock} data-testid="confirm-button" t={translationFunctionMock} />
    );
    ...
    it('disables confirm button when isActionButtonDisabled is true', () => {
      render(
        <ConfirmButton
          title="Delete"
          t={translationFunctionMock}
          dialogConfig={{ isActionButtonDisabled: true, t: translationFunctionMock }}
          data-testid="confirm-button"
        />
      );

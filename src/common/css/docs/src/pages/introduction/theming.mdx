...
:root {
  ...
  --page-background-color-dark: #2a2340;
  ...
  --color-primary-dark: #552a8d;
  --color-primary-medium: #8008f9;
  ...
  --color-spot: #c084fc;
  --color-link: #966ff1;
  --color-link-hover: #552a8d;
  --color-grey-light: #ccc;
  --color-grey-subtle: #fafafa;
  ...
  --form-field-color-dark: black;
  --form-field-background-color: white;
  --form-field-background-color-dark: transparent;
  --form-field-placeholder-color: rgb(141 141 141);
  --form-field-border-color: rgb(207 217 224);
  --form-field-box-shadow: none;
  --form-field-box-shadow-focus: color-mix(in srgb, var(--color-spot) 55%, transparent)
    0 0 0 3px;
  --form-field-border-color-focus: var(--color-primary);
  ...
  --form-field-font-size: var(--type-base-size);

  --type-sans: "GoogleSans-Regular", "Google Sans", system, -apple-system,
    "Segoe UI", "Lucida Grande", sans-serif;
  --type-sans-medium: "GoogleSans-Medium", "Google Sans", system, -apple-system,
    "Segoe UI", "Lucida Grande", sans-serif;
  --type-sans-bold: "GoogleSans-Bold", "Google Sans", system, -apple-system,
  ...
  --authenticator-saml-color: #c32527;
  --authenticator-saml2-color: #c32527;
  --authenticator-totp-color: #4682b4;
  --authenticator-github-color: #333;
  --authenticator-x-color: #0f1419;
  ...
  --authenticator-passkeys-color: #626c87;
  --authenticator-openid-wallet-color: #666;
  ...
  --self-service-portal-login-sidebar-image-display: flex;
  --self-service-portal-login-sidebar-background-color: #262c3d;
  --self-service-portal-sidebar-background-color: white;
  --self-service-portal-main-background-color: white;
}
```

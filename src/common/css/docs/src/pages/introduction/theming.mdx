...
:root {
  ...
  --page-background-color-dark: var(--color-primary-dark);
  ...
  --form-field-background-color-dark: white;
  ...
  --type-weight: normal;
  --type-sans-medium: "Roboto-Medium", system, -apple-system, "Roboto", "Segoe UI",
    "Lucida Grande", sans-serif;
  --type-sans-bold: "Roboto-Bold", roboto, -apple-system, blinkmacsystemfont,
  ...
  --authenticator-openid-wallet-color: #f2f2f2;

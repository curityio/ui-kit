...
describe('ProgressSteps', () => {
  ...
  it('renders custom steps', () => {
    ...
    render(<ProgressSteps currentStep={2} steps={steps} />);
  ...
  it('sets data-steps attribute correctly', () => {
    const { container } = render(<ProgressSteps currentStep={1} />);
  ...
  it('updates correctly when currentStep prop changes', () => {
    const { rerender } = render(<ProgressSteps currentStep={1} />);
    ...
    rerender(<ProgressSteps currentStep={2} />);

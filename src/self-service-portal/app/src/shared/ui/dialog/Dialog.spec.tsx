...
import { Dialog, CurityDialogProps } from './Dialog.tsx';
import '@testing-library/jest-dom';

const setupDialog = (props?: Partial<CurityDialogProps>) => {
  return render(
    <Dialog isOpen={true} title="Test Dialog" {...props}>
      <p>Dialog content</p>
    </Dialog>
  );
};
...
describe('Dialog Component', () => {
  describe('Header', () => {
    it('renders the header programmatically with the correct title text', () => {
      ...
      rerender(<Dialog isOpen={true} showHeader={false} title="Hidden Header" />);
    ...
    it('renders the close button programmatically with the correct aria-label', () => {
      ...
      rerender(<Dialog isOpen={true} showCloseButton={false} />);
  ...
  describe('Footer', () => {
    it('renders the footer with the correct buttons and texts', () => {
      ...
      rerender(<Dialog isOpen={true} showFooter={false} showActionButton={true} showCancelButton={true} />);
      ...
      rerender(<Dialog isOpen={true} showFooter={true} showActionButton={false} showCancelButton={false} />);
